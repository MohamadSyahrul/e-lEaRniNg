...
function default_parser_item($add_item = array())
{
    ...
    $return = array(
        ...
        'copyright_setup'   => 'Copyright &copy; 2019 - ' . date('Y') . ' Lapakcode - <a href="http://www.lapakcode.id">lapakcode.id</a>',
    ...
    if ($CI->uri->segment(1) != 'setup') {
        $return['copyright'] = 'Copyright &copy; 2019 - ' . date('Y') . ' ' . get_pengaturan('nama-sekolah', 'value').' by Lapakcode - <a href="http://www.lapakcode.id">lapakcode.id</a>';
