...
class MY_Controller extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->update_link        = 'http://www.lapakcode.id/category/new-elearning/feed/';
        $this->portal_update_link = 'http://www.lapakcode.id/category/new-elearning/';
        $this->bug_tracker_link   = 'http://www.lapakcode.id/category/bug-tracker-new-elearning/';

        # load helper
        $this->load->helper(array('url', 'form', 'text', 'elearning', 'security', 'file', 'number', 'date', 'download', 'plugins'));

        $error_install = "Install aplikasi e-learning by Lapakcode (www.lapakcode.id): " . anchor('setup', "&rarr; Halaman Install");
        try {
            check_db_connection();
        } catch (Exception $e) {
    ...
    /**
     * Method untuk mengambil informasi yang urgent dari lapakcode.id
     *
    ...
    function check_urgent_info($skip_check_time = false)
    {
        ...
        if ($ok_check) {
            $url_urgent_info = "http://elearningupdates.lapakcode.id/urgent_info.php";
